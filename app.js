...
videoContainer.addEventListener("mouseleave" , function(){
    ...
    videoContainer.addEventListener("click" , function(){
        ...
        document.querySelector("#cursor").innerHTML = `<i class="ri-pause-mini-line"></i>`
        gsap.to("#cursor" , {
            scale:0.5,
        })
        flag=1;
...
textAnime.addEventListener("mouseleave" , function(){
   gsap.to("#footer h1" , {
    opacity:1 ,
    duration:0.3 
   });
